 ...
 */
package app.judo.shaded.exoplayer2.source.hls.playlist;

import android.net.Uri;
import android.text.TextUtils;
import android.util.Base64;
import androidx.annotation.Nullable;
import app.judo.shaded.exoplayer2.source.hls.HlsTrackMetadataEntry;
...
import app.judo.shaded.exoplayer2.drm.DrmInitData.SchemeData;
import app.judo.shaded.exoplayer2.extractor.mp4.PsshAtomUtil;
import app.judo.shaded.exoplayer2.metadata.Metadata;
import app.judo.shaded.exoplayer2.source.UnrecognizedInputFormatException;
...
public final class HlsPlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
  ...
  private static HlsMasterPlaylist parseMasterPlaylist(LineIterator iterator, String baseUri)
    ...
    ArrayList<HlsMasterPlaylist.Rendition> videos = new ArrayList<>();
    ...
    for (int i = 0; i < mediaTags.size(); i++) {
      ...
      switch (parseStringAttr(line, REGEX_TYPE, variableDefinitions)) {
        case TYPE_VIDEO:
          @Nullable HlsMasterPlaylist.Variant variant = getVariantWithVideoGroup(variants, groupId);
          if (variant != null) {
          ...
          if (uri == null) {
            ...
            videos.add(new HlsMasterPlaylist.Rendition(uri, formatBuilder.build(), groupId, name));
          }
          break;
        case TYPE_AUDIO:
          ...
          if (uri != null) {
            formatBuilder.setMetadata(metadata);
            audios.add(new HlsMasterPlaylist.Rendition(uri, formatBuilder.build(), groupId, name));
        ...
        case TYPE_SUBTITLES:
          ...
          subtitles.add(new HlsMasterPlaylist.Rendition(uri, formatBuilder.build(), groupId, name));
          break;
