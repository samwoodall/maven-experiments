 ...
 */
package app.judo.shaded.exoplayer2;
...
import app.judo.shaded.exoplayer2.analytics.AnalyticsCollector;
...
import app.judo.shaded.exoplayer2.audio.AuxEffectInfo;
import app.judo.shaded.exoplayer2.decoder.DecoderCounters;
import app.judo.shaded.exoplayer2.device.DeviceInfo;
import app.judo.shaded.exoplayer2.device.DeviceListener;
...
import app.judo.shaded.exoplayer2.upstream.DefaultBandwidthMeter;
...
import app.judo.shaded.exoplayer2.util.PriorityTaskManager;
import app.judo.shaded.exoplayer2.util.Util;
import app.judo.shaded.exoplayer2.video.VideoDecoderOutputBufferRenderer;
import app.judo.shaded.exoplayer2.video.VideoFrameMetadataListener;
import app.judo.shaded.exoplayer2.video.VideoRendererEventListener;
import app.judo.shaded.exoplayer2.video.spherical.CameraMotionListener;
...
public class SimpleExoPlayer extends BasePlayer
  ...
  /** @deprecated Use {@link app.judo.shaded.exoplayer2.video.VideoListener}. */
  @Deprecated
  public interface VideoListener extends app.judo.shaded.exoplayer2.video.VideoListener {}
  ...
  private final CopyOnWriteArraySet<app.judo.shaded.exoplayer2.video.VideoListener>
      videoListeners;
  ...
  @Override
  public void addVideoListener(app.judo.shaded.exoplayer2.video.VideoListener listener) {
    // Don't verify application thread. We allow calls to this method from any thread.
    Assertions.checkNotNull(listener);
  ...
  @Override
  public void removeVideoListener(app.judo.shaded.exoplayer2.video.VideoListener listener) {
    // Don't verify application thread. We allow calls to this method from any thread.
   ...
   * @deprecated Use {@link #addVideoListener(app.judo.shaded.exoplayer2.video.VideoListener)}.
   */
  @Deprecated
  ...
  /**
   * Equivalent to {@link #removeVideoListener(app.judo.shaded.exoplayer2.video.VideoListener)}.
   *
   * @param listener The listener to clear.
   * @deprecated Use {@link
   *     #removeVideoListener(app.judo.shaded.exoplayer2.video.VideoListener)}.
   */
  @Deprecated
  @SuppressWarnings("deprecation")
  ...
  private void maybeNotifySurfaceSizeChanged(int width, int height) {
    if (width != surfaceWidth || height != surfaceHeight) {
      ...
      for (app.judo.shaded.exoplayer2.video.VideoListener videoListener : videoListeners) {
