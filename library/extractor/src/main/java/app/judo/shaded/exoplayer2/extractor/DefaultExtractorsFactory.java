 ...
 */
package app.judo.shaded.exoplayer2.extractor;

import static app.judo.shaded.exoplayer2.util.FileTypes.inferFileTypeFromResponseHeaders;
import static app.judo.shaded.exoplayer2.util.FileTypes.inferFileTypeFromUri;

import android.net.Uri;
import androidx.annotation.Nullable;
import app.judo.shaded.exoplayer2.extractor.amr.AmrExtractor;
import app.judo.shaded.exoplayer2.extractor.flac.FlacExtractor;
import app.judo.shaded.exoplayer2.extractor.flv.FlvExtractor;
...
import app.judo.shaded.exoplayer2.extractor.ts.AdtsExtractor;
import app.judo.shaded.exoplayer2.extractor.ts.DefaultTsPayloadReaderFactory;
import app.judo.shaded.exoplayer2.extractor.ts.PsExtractor;
