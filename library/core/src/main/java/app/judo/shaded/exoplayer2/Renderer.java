...
public interface Renderer extends PlayerMessage.Target {
   ...
   * {@link ExoPlayer#createMessage(PlayerMessage.Target)}. The message payload should be one of the integer
   ...
   * ExoPlayer#createMessage(PlayerMessage.Target)}. The message payload should be the target {@link
   ...
   * ExoPlayer#createMessage(PlayerMessage.Target)}. The message payload should be a {@link Boolean} instance
   * telling whether to enable or disable skipping silences in the audio stream.
   */
  int MSG_SET_SKIP_SILENCE_ENABLED = 101;
  /**
   * A type of a message that can be passed to an audio renderer via {@link
   * ExoPlayer#createMessage(PlayerMessage.Target)}. The message payload should be an {@link Integer} instance
   ...
   * ExoPlayer#createMessage(PlayerMessage.Target)}, to inform the renderer that it can schedule waking up another
   * component.
   *
