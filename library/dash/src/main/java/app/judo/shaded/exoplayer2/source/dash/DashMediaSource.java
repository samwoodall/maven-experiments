 ...
 */
package app.judo.shaded.exoplayer2.source.dash;
...
import app.judo.shaded.exoplayer2.source.dash.manifest.DashManifestParser;
...
import app.judo.shaded.exoplayer2.offline.FilteringManifestParser;
import app.judo.shaded.exoplayer2.offline.StreamKey;
import app.judo.shaded.exoplayer2.source.BaseMediaSource;
import app.judo.shaded.exoplayer2.source.CompositeSequenceableLoaderFactory;
import app.judo.shaded.exoplayer2.source.DefaultCompositeSequenceableLoaderFactory;
import app.judo.shaded.exoplayer2.source.LoadEventInfo;
import app.judo.shaded.exoplayer2.source.MediaLoadData;
...
import app.judo.shaded.exoplayer2.source.MediaSourceEventListener.EventDispatcher;
import app.judo.shaded.exoplayer2.source.MediaSourceFactory;
import app.judo.shaded.exoplayer2.source.SequenceableLoader;
...
import app.judo.shaded.exoplayer2.upstream.LoadErrorHandlingPolicy;
import app.judo.shaded.exoplayer2.upstream.LoadErrorHandlingPolicy.LoadErrorInfo;
import app.judo.shaded.exoplayer2.upstream.Loader;
import app.judo.shaded.exoplayer2.upstream.Loader.LoadErrorAction;
import app.judo.shaded.exoplayer2.upstream.LoaderErrorThrower;
import app.judo.shaded.exoplayer2.upstream.ParsingLoadable;
...
import app.judo.shaded.exoplayer2.util.SntpClient;
...
public final class DashMediaSource extends BaseMediaSource {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      app.judo.shaded.exoplayer2.source.dash.manifest.Period period =
