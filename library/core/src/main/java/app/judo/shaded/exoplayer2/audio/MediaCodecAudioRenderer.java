 ...
 */
package app.judo.shaded.exoplayer2.audio;
...
import app.judo.shaded.exoplayer2.audio.AudioRendererEventListener.EventDispatcher;
  ...
  protected int supportsFormat(MediaCodecSelector mediaCodecSelector, Format format)
    ...
    if (supportsFormatDrm
      ...
      return RendererCapabilities.create(
          RendererCapabilities.FORMAT_HANDLED, RendererCapabilities.ADAPTIVE_NOT_SEAMLESS, tunnelingSupport);
    }
